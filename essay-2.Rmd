...
ggsave(
  plot = histogram1,
  filename = "editable-figures/temperature/Histogram_data.svg",
  width = 8
)
...
ggsave(
  plot = boxplot1,
  filename = "editable-figures/temperature/Boxplot_data_reduced.svg",
  width = 8
)
...
ggsave(
  plot = boxplot2,
  filename = "editable-figures/temperature/Boxplot_data_full.svg",
  width = 8
)
...
ggsave(
  plot = scatter1,
  filename = "editable-figures/temperature/Scatter_raw_data.svg",
  width = 14,
  height = 6
)
...
ggsave(
  plot = histogram2,
  filename = "editable-figures/culture-media/Histogram_residuals_full_model.svg",
  width = 8
)
...
ggsave(
  plot = scatter2,
  filename = "editable-figures/temperature/Scatter_observed_and_predicted_full_model.svg",
  width = 14,
  height = 6
)
...
ggsave(
  plot = adjust2_plot,
  filename = "editable-figures/temperature/Adjust_residuals_reduced_model.svg",
  width = 3,
  height = 3
)
...
ggsave(
  plot = scatter3,
  filename = "editable-figures/temperature/Scatter_predicted_reduced_model.svg",
  height = 5,
  width = 7
)
